...
{
    [V1ApiController]
    public class BookFileController : ReadarrRestControllerWithSignalR<BookFileResource, BookFile>,
                                 ...
                                 IHandle<BookFileDeletedEvent>
    {
        ...
        private List<BookFileResource> GetBookFiles()
        {
            ...
            if (bookIdQuery.Any())
            {
                string bookIdValue = bookIdQuery.ToString();
            ...
            {
                string bookFileIdsValue = bookFileIdsQuery.ToString();
